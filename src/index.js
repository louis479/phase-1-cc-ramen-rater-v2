...
async function fetchRamens() {
    try {
        const response = await fetch('https://github.com/louis479/phase-1-cc-ramen-rater-v2/blob/c9700ad78662c30402298b890cbb7238b5fb6d71/src/db.json'); // Update this URL to the correct location of your db.json
        if (!response.ok) {
